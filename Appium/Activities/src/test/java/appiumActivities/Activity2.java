...
public class Activity2 {
    ...
    public void textSearchAppium() {
        ...
        MobileElement aboutButton = driver.findElementByXPath("//*[@resource-id=\"about-link\"]");
        aboutButton.click();

        String newPageTitle = driver
                .findElementByXPath("//android.view.View[2][contains(@text,'About Us')]")
                .getText();
