...
public class Activity5 {
    ...
    public void smsTest() throws InterruptedException {
        ...
        driver.findElement(MobileBy.AndroidUIAutomator(contactBoxLocator)).sendKeys("8961378024");
        ...
        // Type in a message
        driver.findElement(MobileBy.AndroidUIAutomator("resourceId(\"com.google.android.apps.messaging:id/compose_message_text\")")).sendKeys("Hey Its me, Appium");
        ...
        Assert.assertEquals(sentMessageText, "Hey Its me, Appium");
    }
