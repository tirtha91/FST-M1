...
public class AlchemyJobsPage extends BaseUtils {
    ...
    @FindBy(how = How.XPATH, using="//textarea[@id=\"post-title-0\"]")
    public WebElement addJobListingTitle;

    @FindBy(how = How.XPATH, using="//input[@id=\"_job_location\"]")
    public WebElement addJobListingLocation;

    @FindBy(how = How.XPATH, using="//input[@id=\"_company_name\"]")
    public WebElement addJobListingCompanyName;

    @FindBy(how = How.XPATH, using="//input[@id=\"_company_website\"]")
    public WebElement addJobListingCompanyWebsite;

    @FindBy(how = How.XPATH, using="//button[contains(text(),\"Publish\")]")
    public WebElement addJobListingPublishBtn;

    @FindBy(how = How.XPATH, using="//a[text()=\"View Job\"]")
    public WebElement addJobListingViewJob;
